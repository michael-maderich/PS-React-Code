...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var kittySchema, Kitten, silence, golden;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Connecting to MongoDB at:", MONGO_URL);
                    return [4 /*yield*/, mongoose.connect(MONGO_URL)];
                case 1:
                    _a.sent();
                    console.log('Started..');
                    ...
                    silence = new Kitten({ name: 'Silence', gender: 'male' });
                    golden = new Kitten({ name: 'Golden', gender: 'female' });
                    return [4 /*yield*/, silence.save()];
                case 2:
                    _a.sent();
